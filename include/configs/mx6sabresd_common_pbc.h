...
#define CONFIG_OTA_ENV_SETTINGS \
	...
	"boot_delay=3\0" \
	"board_type=pbc\0" \
	"do_usb_ota=fatload usb 0:1 ${loadaddr} OTA_uImage.imx6q; setenv bootargs console=${console},${baudrate} noinitrd mmcblk.perdev_minors=16 ota_device=/dev/sda1 ota_filename=ota_pbc.tar.xz; bootm ${loadaddr}\0" \
