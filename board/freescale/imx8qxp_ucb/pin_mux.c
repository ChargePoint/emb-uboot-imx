...
pin_labels:
- {pin_num: U35, pin_signal: ADC_IN0, label: BLU_DET_ADC}
- {pin_num: G31, pin_signal: SPDIF0_RX, label: ENET1_RGMII_RXD0}
- {pin_num: D34, pin_signal: SPDIF0_TX, label: ENET1_RGMII_RX_CTL}
- {pin_num: H24, pin_signal: ENET0_RGMII_TXC, label: ENET0_RGMII_TXC}
- {pin_num: G25, pin_signal: ENET0_RGMII_TXD0, label: ENET0_RGMII_TXD0}
- {pin_num: B28, pin_signal: ENET0_RGMII_TXD1, label: ENET0_RGMII_TXD1}
- {pin_num: E27, pin_signal: ENET0_RGMII_TXD2, label: ENET0_RGMII_TXD2}
- {pin_num: F26, pin_signal: ENET0_RGMII_TXD3, label: ENET0_RGMII_TXD3}
- {pin_num: A29, pin_signal: ENET0_RGMII_TX_CTL, label: ENET0_RGMII_TX_CTL}
- {pin_num: B30, pin_signal: ENET0_RGMII_RX_CTL, label: ENET0_RGMII_RX_CTL}
- {pin_num: H26, pin_signal: ENET0_RGMII_RXD3, label: ENET0_RGMII_RXD3}
- {pin_num: A31, pin_signal: ENET0_RGMII_RXD0, label: ENET0_RGMII_RXD0}
- {pin_num: C29, pin_signal: ENET0_RGMII_RXD1, label: ENET0_RGMII_RXD1}
- {pin_num: G27, pin_signal: ENET0_RGMII_RXD2, label: ENET0_RGMII_RXD2}
- {pin_num: D28, pin_signal: ENET0_RGMII_RXC, label: ENET0_RGMII_RXC}
- {pin_num: B32, pin_signal: ENET0_MDIO, label: ENET0_MDIO}
- {pin_num: D30, pin_signal: ENET0_MDC, label: ENET0_MDC}
- {pin_num: AP28, pin_signal: CSI_EN, label: UX_5V_OC}
- {pin_num: AM26, pin_signal: CSI_MCLK, label: UX_PWR_EN}
- {pin_num: AK26, pin_signal: CSI_PCLK, label: UX_GSTIC_TS}
- {pin_num: AR27, pin_signal: CSI_RESET, label: UX_GSTIC_RSTn}
- {pin_num: U29, pin_signal: ADC_VREFH, label: 1V8}
- {pin_num: U31, pin_signal: ADC_VREFL, label: 0V}
- {pin_num: AK34, pin_signal: ANA_TEST_OUT_N, label: ANA_TESTN_TP50}
- {pin_num: AL35, pin_signal: ANA_TEST_OUT_P, label: ANA_TESTP_TP49}
- {pin_num: F30, pin_signal: ESAI0_FSR, label: ENET1_RGMII_TXC}
- {pin_num: G29, pin_signal: ESAI0_FST, label: ENET1_RGMII_TXD2}
- {pin_num: H28, pin_signal: ESAI0_SCKR, label: ENET1_RGMII_TX_CTL}
- {pin_num: E31, pin_signal: ESAI0_SCKT, label: ENET1_RGMII_TXD3}
- {pin_num: G35, pin_signal: MCLK_IN0, label: RFID_PWR_EN}
- {pin_num: M28, pin_signal: MCLK_IN1, label: I2C3_SDA}
- {pin_num: K30, pin_signal: SPI3_CS1, label: I2C3_SCL}
- {pin_num: G19, pin_signal: EMMC0_CLK, label: EMMC_CLK}
- {pin_num: F22, pin_signal: EMMC0_STROBE, label: EMMC_STROBE}
- {pin_num: C21, pin_signal: EMMC0_DATA0, label: EMMC_DATA0}
- {pin_num: A21, pin_signal: EMMC0_DATA1, label: EMMC_DATA1}
- {pin_num: E21, pin_signal: EMMC0_DATA2, label: EMMC_DATA2}
- {pin_num: H20, pin_signal: EMMC0_DATA3, label: EMMC_DATA3}
- {pin_num: B22, pin_signal: EMMC0_DATA4, label: EMMC_DATA4}
- {pin_num: G21, pin_signal: EMMC0_DATA5, label: EMMC_DATA5}
- {pin_num: A23, pin_signal: EMMC0_DATA6, label: EMMC_DATA6}
- {pin_num: D22, pin_signal: EMMC0_DATA7, label: EMMC_DATA7}
- {pin_num: D20, pin_signal: EMMC0_CMD, label: EMMC_CMD}
- {pin_num: AD30, pin_signal: MIPI_DSI1_GPIO0_00, label: I2C2_SCL}
- {pin_num: AF34, pin_signal: MIPI_DSI1_GPIO0_01, label: I2C2_SDA}
power_domains: {VDD_DDR_VDDQ: '1.1', VDD_PCIE_LDO_1P0_CAP: '1.0', VDD_PCIE_DIG_1P8_3P3: '3.3', VDD_USB_SS3_LDO_1P0_CAP: '1.0', VDD_EMMC0_1P8_3P3: '1.8', VDD_EMMC0_VSELECT_1P8_3P3: '1.8',
  VDD_USDHC1_VSELECT_1P8_3P3: '1.8', VDD_USDHC1_1P8_3P3: '1.8', VDD_ENET0_VSELECT_1P8_2P5_3P3: '2.5', VDD_ENET0_1P8_2P5_3P3: '2.5', VDD_ENET_MDIO_1P8_3P3: '2.5',
  VDD_ESAI_SPDIF_1P8_2P5_3P3: '2.5', VDD_USB_3P3: '3.3', VDD_PCIE_1P8: '1.8', VDD_USB_1P8: '1.8', VDD_SPI_MCLK_UART_1P8_3P3: '3.3', VDD_PCIE0_1P0: '1.8', VDD_SPI_SAI_1P8_3P3: '3.3',
  VDD_USB_OTG_1P0: '1.0', VDD_ANA0_1P8: '1.8', VDD_GPU: '1.1', VDD_ADC_1P8: '1.8', VDD_ADC_DIG_1P8: '1.8', VDD_CAN_UART_1P8_3P3: '3.3', VDD_A53: '1.1', VDD_MIPI_DSI_DIG_1P8_3P3: '3.3',
  VDD_ANA1_1P8: '1.8', VDD_DDR_PLL_1P8: '1.8', VDD_SNVS_4P2: '3.0', VDD_TMPR_CSI_1P8_3P3: '3.3', VDD_QSPI0B_1P8_3P3: '3.3', VDD_QSPI0A_1P8_3P3: '1.8', VDD_MIPI_CSI_DIG_1P8: '1.8',
  VDD_CSI_1P8_3P3: '3.3', VDD_SNVS_LDO_1P8_CAP: '1.8', VDD_MIPI_DSI0_1P8: '1.8', VDD_SCU_ANA_1P8: '1.8', VDD_MIPI_DSI1_1P8: '1.8', VDD_MIPI_CSI0_1P8: '1.8'}
